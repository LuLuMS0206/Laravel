...
<section class="roomsDetail">
    ...
    <div class="roomsDetail__flex">
        <div class="roomsDetail__info">
            ...
            <img class="roomsDetail__info__img" src="{{ asset('assets/imagenes/hotel-luxury.jpg') }}" alt="">
        </div>
        ...
        <div class="roomsDetail__amenities__info">
            <ul class="roomsDetail__amenities__info__ul">
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/airDetail.svg') }}" alt="">
                    <p class="roomsDetail__amenities__info__ul__li__p font--roboto">Air conditioner</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/breakDetail.svg') }}" alt="">
                    <p class="roomsDetail__amenities__info__ul__li__p">Breakfast</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/cleanDetail.svg') }}" alt="">
                    <p>Cleaning</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/groceryDetail.svg') }}" alt="">
                    <p class="roomsDetail__amenities__info__ul__li__p">Grocery</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/shopDetail.svg') }}" alt="">
                    <p class="roomsDetail__amenities__info__ul__li__p">Shop near</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/onlineDetail.svg') }}" alt="">
                    <p class="roomsDetail__amenities__info__ul__li__p">24/7 Online Support</p>
                </li>
                <li class="roomsDetail__amenities__info__ul__li">
                    <img src="{{ asset('assets/imagenes/smartDetail.svg') }}" alt="">
    ...
    <div class="roomsDetail__founder">
        <div class="roomsDetail__founder__container">
            <div class="roomsDetail__founder__container__img">
                <img class="roomsDetail__founder__container__img__photo" src="{{ asset('assets/imagenes/circleDetail.svg') }}" alt="">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="roomsPage__cards">
                        <img class="roomsPage__cards__img" src="{{ asset('assets/imagenes/room-counter.jpg') }}" alt="">

                        <div class="roomsPage__cards__iconGroup">
                            <img src="{{ asset('assets/imagenes/room.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/wifi.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/car.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/winter.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/gym.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/smoke.svg') }}" alt="">
                            <img src="{{ asset('assets/imagenes/cocktel.svg') }}" alt="">
                        </div>
